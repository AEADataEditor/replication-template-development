# AEA Data Editor's Replication Template Documentation

This repository is part of the AEA Data Editor's workflow. It is highly integrated with the workflow, and likely of little independent value. The primary purpose is to document the scripts in more detail.

:::{note}

For the full workflow documentation, see [AEA Jira Workflow](https://labordynamicsinstitute.github.io/ldilab-manual/11-00-jira-workflow.html).
